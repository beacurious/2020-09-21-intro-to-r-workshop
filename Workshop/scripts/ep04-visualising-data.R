...
ggplot(data = surveys_complete, mapping = aes(x = weight, y = hindfoot_length)) +
  geom_point(alpha = 0.1, colour = "green")
...
# Challenge 3
# Use what you just learned to create a scatter plot of weight over species_id with the plot_type 
...
# What do you need to change in the code to put the boxplot in front of the points 
...
# Challenge 6
# So far, we’ve looked at the distribution of weight within species. Make a new plot to explore 
# the distribution of hindfoot_length within each species. Add color to the data points on your 
...
# For example, it may be worth changing the scale of the axis to better distribute the 
# observations in the space of the plot. Changing the scale of the axes is done similarly 
# to adding/modifying other components (i.e., by incrementally adding commands). 
# 
...
# intergrating the pipe operator with ggplot
...
# Challenge 10
# Put together what you’ve learned to create a plot that depicts how the average weight of 
# each species changes through the years.
